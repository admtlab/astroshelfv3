...
@Entity
@Table(name = "survey_access_control")
@XmlRootElement
public class SurveyAccess implements Serializable
{
    ...
    @Column(name = "survey_access_id")
    private int survey_access_id;
    ...
    public SurveyAccess(int survey_access_id, int survey_id, int create_access, int modify_access, 
            int delete_access, int view_access, String operator_type, int operator_id)
    {
        this.survey_access_id = survey_access_id;
    ...
    public int getSurveyAccessId()
    {
        return survey_access_id;
    }
    
    public void setSurveyAccessId(int id)
    {
        survey_access_id = id;
    }
