...
#SWIFT - gamma ray bursts ; takes maybe 30 seconds to grab the feed
...
for i in range(len(astro.entries[0:end])):
	...
	data = { "objectInfoCollection": [obj] , "annoValue": "SkyAlert: Swift, Gamma-Ray Burst Monitor Event {0}, {1}".format(i+1,astro.entries[i].author),
