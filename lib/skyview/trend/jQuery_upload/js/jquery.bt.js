 ...
 * @version 0.9.4  (4/19/2009)
 */
 
jQuery.bt = {version: '0.9.4'};
...
;(function($) { 
  ...
  */
  ...
  jQuery.bt.defaults = {
    ...
    shrinkToFit:      true,                  // should short single-line content get a narrower balloon?
    width:            '200px',               // maximum width of tooltip box
    ...
    centerPointX:     1.0,                    // the spike extends from center of the target edge to this point
    ...
    hideTip:          function(box, callback) {
                        $(box).hide(1, callback);  // you MUST call "callback" at the end of your animations
                      },
