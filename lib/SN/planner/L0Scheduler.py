...
# H(SN) = (w1 + 100 * value) / (w2 + weight) + (w3 + side_fact1) / (1 + w4 + side_fact2)
#
...
class L0Scheduler:
        ...
        def heuristic(self, _supnova, _tmp_set):
                ...
                weight = _supnova.get_obsDuration()
        ...
        def brute_forcely(self):
                ...
                while masking < upper_bound:
                        ...
                        for supnova in fiter_set:
                                local_capacity += supnova.get_obsDuration()
        ...
        def iterative_DP(self):
                ...
                while iteration_times:      
                                ...
                                for i in range(len(candi_set)):
                                                ...
                                                tmp_weight = candi_set[i].get_obsDuration()
                                                i = i + 1 
                                ...
                                while index:
                                                if K[index][C] == 1:
                                                                ...
                                                                C -= candi_set[index-1].get_obsDuration()
                                                index -= 1
                ...
                while restart_nums:
                                ...
                                while True:
                                        ...
                                        if not self.validate_filtered_set(local_set + [candi_set[rand_index]]):
                                                break
                                        if local_capacity + candi_set[rand_index].get_obsDuration() >= self.ncapa:
                                                break

                                        local_set.append(candi_set[rand_index])
                                        local_capacity += candi_set[rand_index].get_obsDuration()
        ...
        def validate_filtered_set(self, _tmp_set):
                ...
                for supnova in _tmp_set:
                        ...
                        L2.append(supnova.get_obsDuration())
