...
*/
function general_sdss_query($sql_string, &$xml_output_string, &$xml_output_object, &$error_message, $timeout = 0){
	$errno_array = array(
		0 => "success",
		-1 => "timeout",
		-2 => "diagnostic",
	...
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, "http://skyserver.sdss.org/dr7/en/tools/search/x_sql.asp?format=xml&cmd=" . $sql_string);
